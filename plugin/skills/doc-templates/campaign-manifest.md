...
These are loaded into context automatically via `@` references when the CLAUDE.md file is read. Universal documents needed for ALL session types. Add one `@` line per companion guide.
...
Add one row per companion. Remove this section entirely if solo campaign.
...
| Document | Path |
|---|---|
| character-info | [campaign-members/pc-[name]/character-info.md](campaign-members/pc-[name]/character-info.md) |
| character-sheet | [campaign-members/pc-[name]/character-sheet.md](campaign-members/pc-[name]/character-sheet.md) |
